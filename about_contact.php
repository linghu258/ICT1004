...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Boasting a wide selection of dishes, find out more information about YUM-YUM's restaurant and catering services here.">
        <meta name="keywords" content="Restaurant, Catering, Singapore, Dining, Food, Buffet, Contact, About">
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="container">
            <article>
                ...
                <hr>
                <p>
                    YUM YUM, located in Ang Mo Kio, provides delicious western food at an affordable price.<br><br>
                    Using only the freshest ingredients, our menu will sure to leave you wanting more.<br><br>
                    With a large breath-taking space with a New York loft view and a stunning mix of vintage and modern
                    interiors, feel<br><br>
                    the buzz of this bustling room as you take a seat and enjoy dinner. Open all-day, seven days a<br><br>
                    week, YUM YUM serves something for everyone with a globally-inspired menu of stoned-baked
                    dishes,<br><br>
                    charcoal grills and an ever-changing range of salads, mains, starters and desserts.<br><br><br>

                    Catering services are provided for all menu items.
                </p>
            </article>
        </section>
