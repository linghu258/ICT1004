...
<html>
    <head>
        ...
        <meta name="description" content="YUM-YUM's restaurant and catering services entrées menu. Mouthwatering, savoury and simply delicious.">
        <meta name="keywords" content="restaurant, catering, menu, reservation, entrees, main-course, entrées">
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="container-fluid imgcontainer">
            <img class="figimage" src="image/ENTREE.png" alt="topimage">
                ...
                <div class="row">
                    ...
                    <figure class="col-md-3">
                        <div class="menue-text-padding">
                            <img src="image/bento1.jpg" alt="Pasta and Wine">
                            <!--<author>Ashley Tyler</author><page name>BRIT+CO</page name><url>https://www.brit.co/vegetarian-bento-box-lunch/</url>-->
                            <h3>Coco Crust Seared shrimp</h3>
                            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto illo delectus...</p>
                        </div>
                    </figure>
                </div>
