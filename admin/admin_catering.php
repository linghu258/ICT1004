            ...
            <div class="container">
                <div class="table-responsive">
                    ...
                    <table id="orderTable" class="table table-striped table-hover">
                        <?php 
                            $sql = "SELECT customer_order.order_id, customer_order.email, customer_information.name, customer_order.productName, customer_order.quantity, ";
                            $sql .= "customer_order.pax, customer_order.totalPrice, customer_information.mobileNumber, customer_information.deliveryDate, ";
